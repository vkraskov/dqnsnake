...
class Agent:
	...
	def _build_model(self):
		...
		in4 = Input(shape=(STATE_NEAR_DXY, STATE_NEAR_DXY, 1))
		conv2d_4_1 = Conv2D(16, (3, 3), activation = 'relu')(in4)
		conv2d_4_2 = Conv2D(32, (1, 1), activation = 'relu')(conv2d_4_1)
		flatten_4 = Flatten()(conv2d_4_2)
		dense_4_1 = Dense(256, activation='relu')(flatten_4)
		...
		model = Model(inputs = [in1 , in2, in4, in3], outputs = dense_f_2)
